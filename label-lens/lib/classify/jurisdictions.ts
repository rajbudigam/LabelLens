...
const JURISDICTION_STATUS: Record<string, { us: string; ca: string; eu: string; }> = {
  ...
  // Emulsifiers
  "polysorbate60": { us: "ALLOWED", ca: "ALLOWED", eu: "ALLOWED" },
  "polysorbate80": { us: "ALLOWED", ca: "ALLOWED", eu: "ALLOWED" },
  "soylecithin": { us: "ALLOWED", ca: "ALLOWED", eu: "ALLOWED" },
  "monoglycerides": { us: "ALLOWED", ca: "ALLOWED", eu: "ALLOWED" },
  "diglycerides": { us: "ALLOWED", ca: "ALLOWED", eu: "ALLOWED" },
  
  // Thickeners
  "carrageenan": { us: "ALLOWED", ca: "ALLOWED", eu: "RESTRICTED" },
  "xanthangum": { us: "ALLOWED", ca: "ALLOWED", eu: "ALLOWED" },
  "guargum": { us: "ALLOWED", ca: "ALLOWED", eu: "ALLOWED" },
  "locustbeangum": { us: "ALLOWED", ca: "ALLOWED", eu: "ALLOWED" },
  
  // Flavor enhancers
  "monosodiumglutamate": { us: "ALLOWED", ca: "ALLOWED", eu: "ALLOWED" },
  ...
  "ascorbicacid": { us: "ALLOWED", ca: "ALLOWED", eu: "ALLOWED" },
  "tarticacid": { us: "ALLOWED", ca: "ALLOWED", eu: "ALLOWED" },
  
  // Default for unknown additives
  "default": { us: "UNKNOWN", ca: "UNKNOWN", eu: "UNKNOWN" }
};
